...
type Page struct {
	...
	URL         string      `v4.7.0:"url" boil:"url" json:"url" toml:"url" yaml:"url"`
	Content     null.String `v4.7.0:"content" boil:"content" json:"content,omitempty" toml:"content" yaml:"content,omitempty"`
	CreatedDate null.Time   `v4.7.0:"created_date" boil:"created_date" json:"created_date,omitempty" toml:"created_date" yaml:"created_date,omitempty"`
	CreatedAt   null.Time   `v4.7.0:"created_at" boil:"created_at" json:"created_at,omitempty" toml:"created_at" yaml:"created_at,omitempty"`

	R *pageR `v4.7.0:"-" boil:"-" json:"-" toml:"-" yaml:"-"`
	L pageL  `v4.7.0:"-" boil:"-" json:"-" toml:"-" yaml:"-"`
}
...
var PageWhere = struct {
	...
	ID:          whereHelperint{field: "\"pages\".\"id\""},
	URL:         whereHelperstring{field: "\"pages\".\"url\""},
	Content:     whereHelpernull_String{field: "\"pages\".\"content\""},
	CreatedDate: whereHelpernull_Time{field: "\"pages\".\"created_date\""},
	CreatedAt:   whereHelpernull_Time{field: "\"pages\".\"created_at\""},
}
...
var (
	pageAllColumns            = []string{"id", "url", "content", "created_date", "created_at"}
	pageColumnsWithoutDefault = []string{"url", "content", "created_date", "created_at"}
